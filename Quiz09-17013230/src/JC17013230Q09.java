...
class TimerRunnable implements Runnable {
	...
	public TimerRunnable(MyLabel bar) {
		this.bar = bar;
	}
...
public class JC17013230Q09 extends JFrame {
	private MyLabel bar = new MyLabel(100); // 바의 최대 크기를 100으로 설정
	
	public JC17013230Q09(String title) {
		super(title);
		...
		TimerRunnable runnable = new TimerRunnable(bar); //스레드 객체 생성
		Thread th = new Thread(runnable);
		th.start(); // 스레드 시쟉
	}

	public static void main(String[] args) {
		new JC17013230Q09("아무키나 빨리 눌러 바 채우기");
	}
}